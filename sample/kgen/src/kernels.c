...
void trusted_Force2Vec_tdist_csr 
(
...
void trusted_Force2Vec_sigmoid_csr 
(
   const char tkern,  // 't' = tdist 's' = sigmoid 
   const INDEXTYPE m, 
   const INDEXTYPE n, 
...
//void Mjoin(PRE,Force2Vec_csr) 
#ifdef DREAL 
void dgForce2Vec_csr
#else
void sgForce2Vec_csr
#endif
(
   const char tkern,  // 't' = tdist 's' = sigmoid 
   const INDEXTYPE m, 
   ...
   switch(tkern)
   {
      case 't': // tdist
         ...
         else
         {
            ...
            {
               trusted_Force2Vec_tdist_csr(tkern, m, n, k, alpha, nnz, rows,
      ...
      case 's': // sigmoid
         ...
         else
         {
            ...
            {
               trusted_Force2Vec_sigmoid_csr(tkern, m, n, k, alpha, nnz, rows,
                                        cols, val, indx, pntrb, pntre, a, lda, 
                                        b, ldb, beta, c,ldc);
               return;
            }
